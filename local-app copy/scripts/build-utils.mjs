...
import { API_URL, LOCAL_APP_DIR } from './paths.mjs'
...
export const CACHE_DIR = path.join(LOCAL_APP_DIR, '.cache')
export const RELEASE_DIR = path.join(LOCAL_APP_DIR, 'release')
