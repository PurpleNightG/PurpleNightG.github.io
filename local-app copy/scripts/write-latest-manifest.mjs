...
const UPDATE_CONFIG_SRC = path.join(LOCAL_APP_DIR, 'portable', 'update-config.json')
...
export function writeLatestManifest(bundleVersion, zipPath, notes = '') {
  ...
  const downloadUrl =
    ...
    'https://gitee.com/NDYian/ziyeguanwangbendi/releases/download/替换为Tag/紫夜官网-本地版-便携包.zip'
