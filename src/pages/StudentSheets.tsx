    ...
    <div className="p-4 sm:p-6">
      <div className="space-y-5">
        <header>
          ...
          <p className="text-sm text-gray-400 mt-1">查看或协作编辑公会共享表格</p>
        </header>
            ...
            {list.map((item) => (
              <li key={item.id}>
                <button
                  ...
                  className="student-glass-panel student-glass-panel--static w-full text-left overflow-hidden group hover:border-emerald-500/25 transition-colors"
                >
